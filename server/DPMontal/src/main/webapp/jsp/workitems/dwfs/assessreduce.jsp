	    	...
	    	<table width="100%">
	    		<tr>
				   ...
				   <%if("其他类".equals(info.getReduceType())){%>
					<tr>
 					  <th>选择考核小组:</th><!--WFS_ASSESSMENT_TEAM -->
					  <td><%=info.getAssessmentTeam()%></td><!-- WFS_ASSESSMENT_TEAM -->
				   	</tr>
					<tr>
					  <th>选择考核专员/绩效管理员:</th><!--WFS_ASSESSMENT_AREA -->
					  <td><%=info.getPerformanceManager()%></td><!-- WFS_ASSESSMENT_AREA -->
				   </tr>					   
				   <%} %>
				   <tr>
					  <th>申请事由:</th>
