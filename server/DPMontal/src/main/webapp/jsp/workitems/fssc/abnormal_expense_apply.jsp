	...
	<div id="div2">
    	...
    	<div class="tableBox">
	    	<table width="100%">
				...
				<tr>
				   <th>项目类型:</th>
				   <td><%=baseEntity.getProjectType()==null?"":baseEntity.getProjectType() %></td>
				</tr>
				<tr>
				   <th>项目名称:</th>
				   <td><%=baseEntity.getProjectName()==null?"":baseEntity.getProjectName() %></td>
				</tr>
				<tr>
				   <th>申请事由及说明:</th>
				...
				<tr>
					<th>付款金额:</th>
					<td><%=line.getPayAmount() %></td>
				</tr>
				<tr>
					<th>费用说明:</th>
					<td><%=line.getCostExplain()==null?"":line.getCostExplain() %></td>
				</tr>
				<%
					}
				%>				
