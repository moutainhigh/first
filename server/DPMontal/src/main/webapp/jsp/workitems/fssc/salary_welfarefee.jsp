	...
	<div id="div2">
    	...
    	<div class="tableBox">
	    	<table width="100%">
				...
				<tr><th>所属薪酬组:</th><td><%=info.getSalaryGroupName()%></td></tr>
				<tr><th>最迟汇款日期:</th><td><%=info.getLatestRemitDateStr()%></td></tr>
				...
				<tr><th>实发小计:</th><td><%=FormatUtil.formatMoney(line.getActualAmount())%></td></tr>
