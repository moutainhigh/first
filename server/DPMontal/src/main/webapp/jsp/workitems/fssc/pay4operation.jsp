	    	...
	    	<table width="100%">
				...
				<tr>
				   ...
				   <tr>
					...
					<tr>
						<th >最迟汇款日期:</th>
						<td><%="".equals(base.getLatestRemitDateStr())? FormatUtil.formateDateAdd(new Date(),2) : base.getLatestRemitDateStr()%></td>
					</tr>
					<tr>
						<th >手机号码:</th>
				   ...
				   <tr>
					...
					<%for(int i = 0; i < mobileLineList.length; i++ ) {%>
				     ...
				     <tr>
					  <th>业务发生日期:</th>
					  <td><%= mobileLineList[i].getBizOccurDate() == null ? "" : FormatUtil.formatDate(mobileLineList[i].getBizOccurDate())%></td>
				   </tr>
				   <tr>
				     <th>费用承担部门:</th>
