	...
	<div id="div2">
    	...
    	<div class="tableBox">
	    	<table width="100%">
				...
				<tr><th>工作流:</th><td>薪酬福利报账-员工生育保险-报销</td></tr>				
				...
				<tr><th> 所属薪酬组:</th><td><%=baseEntity.getSalaryGroupName()%></td></tr>
				...
				<tr><th>手机号码:</th><td><%=baseEntity.getContactInfo()==null?"":baseEntity.getContactInfo() %></td></tr>
