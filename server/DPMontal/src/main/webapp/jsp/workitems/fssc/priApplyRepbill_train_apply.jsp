	...
	<div id="div2">
    	...
    	<div class="tableBox">
	    	<table width="100%">
			    ...
			    <tr><th >工作流名称:</th><td>事前申请单-培训费</td></tr>	
				...
				<tr><th >是否借款:</th><td><%="y".equalsIgnoreCase(base.getIsLoan())? "是" : "否"%></td></tr>
				...
				<tr><th >培训类型:</th><td><%=base.getBizType() == null ? "无" : base.getBizType() %></td></tr>
				<tr><th >培训名称:</th><td><%=base.getBizName() == null ? "无" : base.getBizName() %></td></tr>
				<tr><th >报销主体:</th><td><%=base.getMainBodyName()==null?"无":base.getMainBodyName()%></td></tr>
				<tr><th >所属事业部:</th><td><%=base.getBusinessDept() == null ? "无" : base.getBusinessDept() %></td></tr>
