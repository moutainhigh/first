	    	...
	    	<table width="100%">
				...
				<tr>
				   ...
				   <tr>
					...
					<tr>
						<th >是否借款:</th>
						<td><%="Y".equals(base.getIsLoan()) ? "是" : "否" %></td>
					</tr>
					<tr>
						<th >支付方式:</th>
						<td><%=base.getPayType() == null ? "" : base.getPayType()%></td>
					</tr>
					<tr>
						<th >收款方:</th>
					...
					<tr>
						<th >文化活动类型:</th>
						<td><%=base.getBizType() == null ? "" : base.getBizType()%></td>
					</tr>
					<tr>
						<th>申请事由及说明:</th>
					...
					<tr>
					  <th>预计金额:</th>
					  <td><%=FormatUtil.formatMoney(base.getPlanAmount())%></td>
				   </tr>
				   <tr>
					  <th>借款金额:</th>
					  <td><%=base.getPlanAmount() == null ? "" : base.getPlanAmount()%></td>
				   </tr>
				    <tr>
					  <th>预计金额大写:</th>
					  <td id='amountCNY'></td>
				   ...
				   <tr>
					  <th>账户性质:</th>
					  <td><%=base.getAccountNature()  == null ? "" : base.getAccountNature()%></td>
				   </tr>
				   <tr>
					  <th>银行账号:</th>
					  <td><%= base.getAccount()  == null ? "" : base.getAccount()%></td>
				   </tr>
				   <tr>
					  <th>开户支行:</th>
					  <td><%=base.getSubbankName()  == null ? "" : base.getSubbankName()%></td>
				   </tr>
					<tr class="yellow">
				   ...
				   <th>费用承担部门:</th>
				    ...
				    <tr>
					  <th>预计金额:</th>
					  <td><%= FormatUtil.formatMoney(mobileLineList[i].getPlanAmount())%></td>
				   </tr>
				    <tr>
					  <th>借款金额:</th>
...
$(function(){
	//将付款金额转成大写
	$("#amountCNY").html(numToCny(<%=base.getPlanAmount()%>));
});
</script>
</body>
</html>