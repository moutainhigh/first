    	...
    	<div class="tableBox">
	    	<table width="100%">
	    		...
	    		<tr>
				   ...
				   <td id="workid"><%=baseEntity.getClaimNo() %>
				   	<input type="hidden" id="workid" value="<%=baseEntity.getWfInstanceId() %>">
				   </td>
				</tr>
				<tr><th>工作流:</th><td>薪酬福利报账-派遣工资-付款</td></tr>				
				...
				<tr><th>申请事由及说明:</th><td><%=baseEntity.getCostExplain() %></td></tr>				
				...
				<tr class='myAmount'><th>核定金额:</th><td><%=FormatUtil.formatMoney(baseEntity.getRatifyAmount()) %></td></tr>
				<tr><th>币种:</th><td><%=baseEntity.getCurrency() %></td></tr>
				<tr><th>收款方:</th><td><%=baseEntity.getAccountName() %></td></tr>
				...
				<tr class='myAmount'><th>核定金额:</th><td><%=line.getActualAmount()%></td></tr>
				<%
					}
				%>				
		  </table>
