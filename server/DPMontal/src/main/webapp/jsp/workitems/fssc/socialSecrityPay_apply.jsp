	    	...
	    	<table width="100%">
				...
				<tr>
				   ...
				   <tr>
					...
					<tr><th>所属薪酬组:</th><td><%=base.getSalaryGroupName()%></td></tr>
					<tr>
						<th >支付方式:</th>
				   ...
				   <tr>
				    ...
				    <tr>
					  <th>费用期间:</th>
					  <td><%= mobileLineList[i].getCostPeriod()%></td>
				   </tr>
				    <tr>
					  <th>员工姓名:</th>
					  <td><%= mobileLineList[i].getEmpName()==null?"无":mobileLineList[i].getEmpName()%></td>
				   </tr>
				    <tr>
					  <th>员工工号:</th>
					  <td><%= mobileLineList[i].getEmpCode()==null?"无":mobileLineList[i].getEmpCode()%></td>
				   </tr>
				    <tr>
					  <th>社保主体:</th>
					  <td><%= mobileLineList[i].getSecurityUnits()==null?"无":mobileLineList[i].getSecurityUnits()%></td>
				   </tr>
				    <tr>
					  <th>实发小计:</th>
