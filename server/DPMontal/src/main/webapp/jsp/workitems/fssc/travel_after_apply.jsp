				...
				<tr>
				   ...
				   <tr>
					...
					<tr><th>所属财务部:</th><td><%=base.getFinancialDept()%></td></tr>
 					<tr><th>是否借款:</th><td><%="y".equals(base.getIsLoan())||"Y".equals(base.getIsLoan()) ? "是":"否"%></td></tr> 
<%-- 					<tr><th>是否借款:</th><td><%=base.getIsLoan()%></td></tr> --%>
					 <%if("y".equals(base.getIsLoan())||"Y".equals(base.getIsLoan())){%>
				   <tr>
						<th >币种:</th>
