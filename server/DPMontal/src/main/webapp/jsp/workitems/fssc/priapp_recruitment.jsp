	...
	<div id="div2">
    	...
    	<div class="tableBox">
	    	<table width="100%">
				...
				<tr><th>是否借款:</th><td><%="y".equalsIgnoreCase(info.getIsLoan())?"是":"否"%></td></tr>
				...
				<tr><th>项目类型:</th><td><%=protype%></td></tr>
				...
				<tr><th>预计金额:</th><td><%=FormatUtil.formatMoney(info.getApplyAmount())%></td></tr>
				<tr><th>借款金额:</th><td><%=FormatUtil.formatMoney(info.getPlanAmount())%></td></tr>
				<tr><th>币种:</th><td><%=info.getCurrency()%></td></tr>
				<tr><th>预计金额大写:</th><td id="amountCNY"></td></tr>
				<tr><th>账户性质:</th><td><%=info.getAccountNature()==null?"":info.getAccountNature()%></td></tr>
				<tr><th>银行账号:</th><td><%=info.getAccount()==null?"":info.getAccount()%></td></tr>
				<tr><th>开户支行:</th><td><%=info.getSubbankName()==null?"":info.getSubbankName()%></td></tr>
				...
				<tr><th>预计金额:</th><td><%=FormatUtil.formatMoney(line.getPlanAmount())%></td></tr>
				<tr><th>借款金额:</th><td><%=FormatUtil.formatMoney(line.getActualAmount())%></td></tr>
				<%} %>
		  </table>
