	    	...
	    	<table width="100%">
				...
				<tr>
				   ...
				   <tr>
					...
					<tr>
						<th >培训类型:</th>
						<td><%=base.getBizType()==null?"无":base.getBizType()%></td>
					</tr>
					<tr>
						<th >培训名称:</th>
						<td><%=base.getBizName() == null ? "无" : base.getBizName() %></td>
					</tr>
					<tr>
						<th >报销主体:</th>
						<td><%=base.getMainBodyName()%></td>
					</tr>
				   ...
				   <tr class='myAmount'>
						<th>核定金额:</th>
						<td><%=mobileLineList[i].getRetifyAmount() %></td>
				   </tr>
				    <tr>
					  <th>费用说明:</th>
