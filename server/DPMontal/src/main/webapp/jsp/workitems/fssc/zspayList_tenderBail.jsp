...
<!-- 				   </tr> -->
				   ...
				   <tr>
					...
					<tr>
					  <th>汇款人账号:</th>
					  <td><%= mobileLineList[i].getAccountNo() == null ? "无" : mobileLineList[i].getAccountNo()%></td>
				   </tr>
				   <tr>
					  <th>是否中标:</th>
					  <td><%="Y".equals(mobileLineList[i].getIsWin()) ? "是":"否" %></td>
				   </tr>
				   <% if("Y".equals(mobileLineList[i].getIsWin())){%>
					<tr>
					  <th>合同到期日:</th>
					  <td><%= mobileLineList[i].getExpireDate() == null ? "无" : mobileLineList[i].getExpireDate()%></td>
				   </tr>
				   <%} %>
				   <tr>
					  <th>退款日期:</th>
					  <td><%= mobileLineList[i].getRefundDate() == null ? "无" : mobileLineList[i].getRefundDate()%></td>
				   </tr>
				   <% if("N".equals(mobileLineList[i].getIsWin())){%>
					    <tr>
					  <th>招标日期:</th>
					  <td><%= mobileLineList[i].getInviteBidDate() == null ? "无" : mobileLineList[i].getInviteBidDate()%></td>
				   </tr>
				   <%} %>
				   <tr>
				    ...
				    <tr>
					  <th>剩余金额:</th>
					  <td><%=FormatUtil.formatMoney((mobileLineList[i].getAblePayAmount().subtract(mobileLineList[i].getDeductBreachAmount())).subtract(mobileLineList[i].getPayAmount()))%></td>
				   </tr>
				   <%} %>
		  </table>
