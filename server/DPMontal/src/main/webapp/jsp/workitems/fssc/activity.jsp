	...
	<div id="div2">
    	...
    	<div class="tableBox">
	    	<table width="100%">
				...
				<tr><th>工作流:</th><td>文化活动费-报销</td></tr>
				...
				<tr><th>最迟汇款日期:</th><td><%=base.getLatestRemitDateStr()== null ? "" : base.getLatestRemitDateStr()%></td></tr>
				...
				<tr><th>文化活动类型:</th><td><%=base.getBizType()%></td></tr>
				<tr><th>所属事业部:</th><td><%=base.getBusinessDept()%></td></tr>
				<tr><th>事前申请单号:</th><td><%=base.getPriorClaimNo()%></td></tr>
				<tr><th>申请事由及说明:</th><td><%=base.getCostExplain()%></td></tr>
