	...
	<div id="div2">
    	...
    	<div class="tableBox">
	    	<table width="100%">
				...
				<tr><th>工作流名称:</th><td>日常费用报销单-通讯费</td></tr>
				...
				<tr><th>项目类型:</th><td ><%=info.getProjectType()==null?"":info.getProjectType() %></td></tr>
				<tr><th>项目名称:</th><td ><%=info.getProjectName()==null?"":info.getProjectName() %></td></tr>
				<tr><th>所属财务部:</th><td><%=info.getFinancialDept()%></td></tr>
				<tr><th>最迟汇款日期:</th><td><%=StringUtils.isEmpty(info.getLatestRemitDateStr())?dateStr:info.getLatestRemitDateStr()%></td></tr>
				<tr><th>申请事由及说明:</th><td><%=StringUtils.isEmpty(info.getCostExplain())?"":info.getCostExplain()%></td></tr>       
