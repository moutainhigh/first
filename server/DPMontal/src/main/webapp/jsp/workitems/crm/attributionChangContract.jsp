	...
	<div id="div2">
    	...
    	<div class="tableBox">
	    	<table width="100%">
				...
				<tr>
				   <th >工作流:</th>
				   <td> <% if("com.deppon.bpms.module.crm.bpsdesign.administLegal.attributionChangContract".equals(processdefname)){%>
					   月结合同归属变更
				 <%}else{%>
				月结合同归属变更
				 <%} %>  </td>
				...
				<tr>
				   ...
				   <tr>
				    ...
				    <tr>
					  <th>即日退代收折扣:</th><!-- 客户编码(合同编码)/  即日退代收折扣(无) -->
					  <td><%=base.getExpWxpgenerationRateDiscount()==null?"":base.getExpWxpgenerationRateDiscount() %></td>
				   </tr>
				   <tr>
					  <th>保价费率折扣:</th>
				   ...
				   <tr class="yellow">
						<td colspan="2" >申请归属变更如下</td>
					</tr>
					 <tr  >
					  <th>现在归属部门:</th>
					   <td><%=base.getAscriptionDeptName()==null?"":base.getAscriptionDeptName()%></td>
				   </tr>    
					
				   <tr>
					  <th> 申请变更部门:</th>
					  <td><%=base.getApplyRenewalDeptName()==null?"":base.getApplyRenewalDeptName()%></td>
				   </tr>
<!-- 				    <tr> -->
<!-- 					  <th>已上传附件:</th> -->
