    ...
    <div id="div2">
    	<div class="ulBox2">
    		<ul>
				...
				<li>工作流:<em>事前申请报账单-文化活动费-事前申请</em></li>				
				...
				<li>是否借款:<em><%="Y".equals(baseEntity.getIsLoan()) ? "是" : "否" %></em></li> 
				...
				<li>文化活动类型:<em><%=baseEntity.getBizType() == null ? "" : baseEntity.getBizType()%></em></li>
				<li>申请事由及说明:<em><%=baseEntity.getCostExplain() == null ? "" : baseEntity.getCostExplain() %></em></li>				
				
				
				
				<li><em class="yellow">付款信息</em></li>
				<li>预计金额:<em><%=FormatUtil.formatMoney(baseEntity.getPlanAmount())%></em></li>
				<li>借款金额:<em><%=baseEntity.getPlanAmount() == null ? "" : baseEntity.getPlanAmount()%></em></li>
...
$(function(){
	//将付款金额转成大写
	$("#amountCNY").html(numToCny(<%=baseEntity.getPlanAmount()%>));
});
</script>
</html>