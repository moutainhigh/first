	...
	<div id="div2">
    	<div class="ulBox2">
	    	<ul>
			   ...
			   <input type="hidden" id ="type_id" value="rentCarOutsides">
<%-- 		   <input type="hidden" id ="currentnode_id" value="<%=info.getCurrentnode() %>"> --%>
			   </em></li>
				   <li>工作流:<em>付款单—外请车</em></li>
				  ...
				  <li id="queryOutsideCar_id">查询中,请稍等...</li>
	    	</ul>
	    </div>
...
function autoShowOutsideCar(){
	...
	$.ajax({
		...
		success:function(msg){
			...
			$("#queryOutsideCar_id").hide();
			$("#queryOutsideCar_id").after(html);
		}
	});
}
setTimeout(autoShowOutsideCar,100);
</script>
</html>