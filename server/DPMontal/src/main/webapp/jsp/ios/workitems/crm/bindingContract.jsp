		...
		<div id="div2">
			<div class="ulBox2">
				...
				<li>
				   工作流:
				   <em>
				 <% if("com.deppon.bpms.module.crm.bpsdesign.administLegal.bindingContract".equals(processdefname)){%>
					  月结合同绑定
				 <%}else{%>
				月结合同绑定
				 <%} %>  
				...
				<li>
				   ...
				   <li>
				    ...
				    <li class="yellow">
						<em class="yellow">申请绑定如下</em>
					</li>
					 <li>
					合同归属部门:
					  <em><%=base.getContrctAscriptionDeptName()== null?"":base.getContrctAscriptionDeptName() %></em>
				   </li>
				    <li>
					  合同绑定部门:
					  <em><%=base.getApplyBondingDeptName()== null?"":base.getApplyBondingDeptName() %></em>
				   </li>
