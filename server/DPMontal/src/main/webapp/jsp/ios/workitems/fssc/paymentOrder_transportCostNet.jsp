...
$(function(){
	...
	//直接上级、总监级、事业部总裁级、副总级、事业部财务部负责人 显示审批界面
// 	var activitydefid = $("#activitydefid").val();
// 	if(activitydefid != 'manualActivity111' &&  activitydefid != 'manualActivity1111'  && activitydefid !='manualActivity9' && activitydefid != 'manualActivity1111' && activitydefid != 'manualActivity' && activitydefid != 'manualActivity11' ){
// 		$("#approve_area").hide();
// 		$("#div3").hide();
// 	}
});
