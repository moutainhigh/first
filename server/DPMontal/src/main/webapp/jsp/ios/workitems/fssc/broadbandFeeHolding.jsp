    ...
    <div id="div2">
    	<div class="ulBox2">
    		<ul>
				...
				<li>工作流:<em>预提报账单-宽带及初装费-预提</em></li>				
				...
				<li>费用所属月份:<em><%=baseEntity.getCostMonth()==null?"":baseEntity.getCostMonth() %></em></li>
				<li>申请事由及说明:<em><%=baseEntity.getCostExplain()==null?"":baseEntity.getCostExplain() %></em></li>				
				
				<li><em class="yellow">付款信息</em></li>
				<li>预提金额:<em><%=FormatUtil.formatMoney(baseEntity.getApplyAmount()) %></em></li>
				<li>币种:<em><%=baseEntity.getCurrency() %></em></li>
				...
				<li>预提金额:<em><%=line.getActualAmount()%></em></li>
				<li>核定金额:<em><%=line.getActualAmount()%></em></li>
