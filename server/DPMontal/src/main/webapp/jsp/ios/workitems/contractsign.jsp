    ...
    <div id="div2">
    	<div class="ulBox2">
    		<ul>
				...
				%>				       
					   <li>物品名称：<em><%=apply.getItemname()%></em></li>
				<%
						if(null != apply.getIsframecontract() && apply.getIsframecontract().toString().equals("1")){
				%>
					   <li>数量：<em><%=apply.getQuantity()%></em></li>
				<%
					    }
				%>	
				       <li>单价：<em><%=apply.getUnitprice()%></em></li>
				<%
					}
				%>		
				 ...
				 <%if("1".equals(apply.getSeal())){%>
						<li>优先盖章方:<em>我方先盖章/签字</em></li>					 
				 <%}else{%>
					 	<li>优先盖章方:<em>对方先盖章/签字</em></li>
				 <%} %>      
