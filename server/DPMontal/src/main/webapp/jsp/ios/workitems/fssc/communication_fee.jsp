	...
	<div id="div2">
    	<div class="ulBox2">
	    	<ul>
				...
				<li>项目类型:<em><%=info.getProjectType()==null?"":info.getProjectType()%></em></li>
				<li>项目名称:<em><%=info.getProjectName()==null?"":info.getProjectName()%></em></li>
				<li>所属财务部:<em><%=info.getFinancialDept()%></em></li>
				<li>最迟汇款日期:<em><%=StringUtils.isEmpty(info.getLatestRemitDateStr())? dateStr : info.getLatestRemitDateStr()%></em></li>
