...
<%
	...
	ClaimLineFssc[]  mobileLineList = entity.getMobileLineArray();
%>
<body>
<div id="list">
    ...
    <div id="div2">
    	<div class="ulBox2">
    		<ul>
				...
				<li>费用类型:<em><%=mobileLineList[0].getScName() == null ? "" : mobileLineList[0].getScName()%></em></li>
