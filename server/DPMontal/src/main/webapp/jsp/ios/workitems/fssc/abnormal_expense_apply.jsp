    ...
    <div id="div2">
    	<div class="ulBox2">
    		<ul>
				...
				<li>项目类型:<em><%=baseEntity.getProjectType()==null?"":baseEntity.getProjectType()  %></em></li>
				<li>项目名称:<em><%=baseEntity.getProjectName()==null?"":baseEntity.getProjectName()%></em></li>
				...
				<li>付款金额:<em><%=line.getPayAmount()  %></em></li>
