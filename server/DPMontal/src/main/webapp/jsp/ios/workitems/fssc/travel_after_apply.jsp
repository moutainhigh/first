    ...
    <div id="div2">
    	<div class="ulBox2">
    		<ul>
				...
				<li>是否借款:<em><%="y".equals(baseEntity.getIsLoan())||"Y".equals(baseEntity.getIsLoan()) ? "是":"否"%></em></li>
				<%if("y".equals(baseEntity.getIsLoan())||"Y".equals(baseEntity.getIsLoan())){%>
