...
<body>
<%
      CCWelfareexpense info = (CCWelfareexpense)request.getAttribute("benifitFee");
%>
<div id="list">
	...
	<div id="div2">
    	<div class="ulBox2">
	    	<ul>
			   ...
			   <input type="hidden" id ="type_id" value="benifitFee">
<%-- 		   <input type="hidden" id ="currentnode_id" value="<%=info.getCurrentnode() %>"> --%>
			   </li>
				   <li>工作流:<em>福利费用报销单</em></li>
				  ...
				  <li id="benifitFee_id">查询中,请稍等...</li>
	    	</ul>
	    </div>
...
function benifitFee(){
	...
	$.ajax({
		type:"GET",
		url:"<%=basePath%>/getbenifitFeeEntry",
		...
		success:function(msg){
			...
			$("#benifitFee_id").hide();
			$("#benifitFee_id").after(html);
		}
	});
}
setTimeout(benifitFee,100);
</script>
</html>