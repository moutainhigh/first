...
$(function(){
	...
	//直接上级、逐级审批至业务部门副总、事业部财务部负责人、总裁
	var activitydefid = $("#activitydefid").val();
	if(activitydefid != 'manualActivity1' && activitydefid != 'manualActivity0' && activitydefid != 'manualActivity7' && activitydefid != 'manualActivity10'){
		$("#approve_area").hide();
		$("#div3").hide();
	}
});
