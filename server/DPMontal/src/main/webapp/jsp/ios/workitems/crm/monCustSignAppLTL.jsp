		...
		<div id="div2">
			<div class="ulBox2">
				...
				<li>
				   工作流:
				   <em>
				 <% if("com.deppon.bpms.module.crm.bpsdesign.administLegal.monCustSignAppLTL".equals(processdefname)){%>
					   零担月结合同签订申请
				 <%}else{%>
				 快递月结合同签订申请
				 <%} %>  
				...
				<li>
				   ...
				   <li>
				    ...
				    <li>
					  即日退代收折扣:<!-- 客户编码(合同编码)/  即日退代收折扣(无) -->
					  <em><%=base.getExpWxpgenerationRateDiscount()== null?"":base.getExpWxpgenerationRateDiscount() %></em>
				   </li>
				   <li>
					  保价费率折扣:
