	...
	<div id="div2">
    	<div class="ulBox2">
	    	<ul>
				...
				<li>所属事业部:<em><%=info.getSalaryGroupName() %></em></li>
				...
				<li>报账金额:<em><%=FormatUtil.formatMoney(info.getApplyAmountStd())%></em></li>
				...
				<li>核定金额:<em><%=FormatUtil.formatMoney(info.getRatifyAmount())%></em></li>
				<%} %>
				...
				<li>费用承担部门:<em><%=line.getCostCenterName()==null?"":line.getCostCenterName()%></em></li>
				...
				<% if("总裁".equals(info.getWfStateCn())) {%>
				<li>核定金额:<em><%=FormatUtil.formatMoney(line.getRetifyAmount())%></em></li>
				<%} }%>
		  </ul>
		</div>
