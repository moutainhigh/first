...
<%@page import="com.deppon.fssc.module.claim.salary.shared.domain.ClaimLineSalaryEntity"%>
    ...
    <div id="div2">
    	<div class="ulBox2">
    		<ul>
				...
				<li>工作流:<em>薪酬福利报账-社保管理费（派遣）—付款</em></li>				
				...
				<li>管理费:<em><%=FormatUtil.formatMoney(line.getManageFee())%></em></li>
				<li>个人社保扣款:<em><%=FormatUtil.formatMoney(line.getPersonalTotSocialSecurity())%></em></li>
				<li>单位社保扣款:<em><%=FormatUtil.formatMoney(line.getCompTotSocialSecurity())%></em></li>
				<li>社保卡费用:<em><%=FormatUtil.formatMoney(line.getSocialSecurityCardFee())%></em></li>
				<%
					}
				%>				
		  </ul>
