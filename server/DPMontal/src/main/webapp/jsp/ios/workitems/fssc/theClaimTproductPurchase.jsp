    ...
    <div id="div2">
    	<div class="ulBox2">
    		<ul>
				...
				<li>工作流:<em>资金运作报账单-理财产品-购买</em></li>				
				...
				<li>账户类型:<em><%=baseEntity.getAccountType() %></em></li>
				<li>开户银行:<em><%=baseEntity.getBankName() %></em></li>
...
$(function(){
	...
	if(activitydefid != 'manualActivity1' &&  activitydefid != 'manualActivity6' &&  activitydefid != 'manualActivity11' &&  activitydefid != 'manualActivity12' &&  activitydefid != 'manualActivity17' ){
