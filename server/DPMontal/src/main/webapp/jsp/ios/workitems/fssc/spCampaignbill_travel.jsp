    ...
    <div id="div2">
    	<div class="ulBox2">
    		<ul>
				...
				<li>工作流:<em>专项活动报账单-差旅费-报销</em></li>				
...
$(function(){
	...
	//直接上级、总监级、高级总监级、副总级、区域财务管理部负责人
	/* var activitydefid = $("#activitydefid").val();
	if(activitydefid != 'manualActivity14' &&  activitydefid != 'manualActivity111' &&  activitydefid != 'manualActivity1112' && activitydefid != 'manualActivity1111' && activitydefid != 'manualActivity81' && activitydefid != 'manualActivity11'){
