    ...
    <div id="div2">
    	<div class="ulBox2">
    		<ul>
				...
				<li>培训类型:<em><%=baseEntity.getBizType() == null? "无": baseEntity.getBizType() %></em></li>
				<li>培训名称:<em><%=baseEntity.getBizName() == null ? "无" :baseEntity.getBizName()%></em></li>
				<li>报销主体:<em><%=baseEntity.getMainBodyName()%></em></li>
				<li>所属财务部:<em><%=baseEntity.getFinancialDept()%></em></li>
				<li>所属事业部:<em><%=baseEntity.getBusinessDept()%></em></li>
				<li>事前申请单号:<em><%=baseEntity.getPriorClaimNo() == null ? "" : baseEntity.getPriorClaimNo() %></em></li>
				...
				<li class='myAmount'>核定金额:<em><%=line.getRetifyAmount() %></em></li>
				<%
					}
				%>				
		  </ul>
