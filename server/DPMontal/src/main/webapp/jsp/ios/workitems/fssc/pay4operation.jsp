    ...
    <div id="div2">
    	<div class="ulBox2">
    		<ul>
				...
				<li>工作流:<em>FOSS报账单- Foss运作成本-付款</em></li>				
				...
				<li>最迟汇款日期:<em><%="".equals(baseEntity.getLatestRemitDateStr())? FormatUtil.formateDateAdd(new Date(),2) : baseEntity.getLatestRemitDateStr()%></em></li>
				...
				<li>业务发生日期:<em><%= line.getBizOccurDate() == null ? "" : FormatUtil.formatDate(line.getBizOccurDate())%></em></li>
