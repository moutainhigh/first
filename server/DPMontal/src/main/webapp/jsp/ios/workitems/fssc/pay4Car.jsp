    ...
    <div id="div2">
    	<div class="ulBox2">
    		<ul>
				...
				<li>工作流:<em>FOSS报账单-专线外请车异常扣款支付</em></li>
				...
				<li class="changeByAccount">核定金额:<em><%=FormatUtil.formatMoney(base.getRatifyAmount())%></em></li>
				...
				<li>业务发生日期:<em><%= FormatUtil.formatDate(mobileLineList[i].getBizOccurDate(), "yyyy-MM-dd")%></em></li>
				<li>报账金额:<em><%= FormatUtil.formatMoney(mobileLineList[i].getActualAmountStd())%></em></li>
				<li class="changeByAccount">核定金额:<em><%= FormatUtil.formatMoney(mobileLineList[i].getRetifyAmount())%></em></li>
