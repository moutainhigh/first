...
$(function(){
	...
	//直接上级、总监级、高级总监级、副总、事业部财务部负责人节点显示审批界面
// 	var activitydefid = $("#activitydefid").val();
// 	if(activitydefid != 'manualActivity3' &&  activitydefid != 'manualActivity4'  && activitydefid !='manualActivity5' && activitydefid != 'manualActivity24' && activitydefid != 'manualActivity15'){
// 		$("#approve_area").hide();
// 		$("#div3").hide();
// 	}
});
