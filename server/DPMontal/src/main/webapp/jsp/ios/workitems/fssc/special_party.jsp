    		...
    		<ul>
				...
				<li>
				   ...
				   <li>
					...
					<li>
						项目类型:
						<em><%=baseEntity.getProjectType()==null?"无":baseEntity.getProjectType()%></em>
					</li>
					<li>
						项目名称:
						<em><%=baseEntity.getProjectName() == null ? "无" : baseEntity.getProjectName() %></em>
					</li>
					<li>
						事前申请单号:
						<em><%=baseEntity.getPriorClaimNo() == null ? "" : baseEntity.getPriorClaimNo() %></em>
					</li>
					<li>
						申请事由及说明:
				   ...
				   <li>
					  核销金额:
					  <em><%=FormatUtil.formatMoney(baseEntity.getAlreadyWritedAmount())%></em>
				   </li>
				   <li>
					  付款金额:
				   ...
				   <li class='myAmount'>核定金额:<em><%=FormatUtil.formatMoney(baseEntity.getRatifyAmount())%></em></li>
				   <li>
					  账户性质:
				...
				<li class='myAmount'>核定金额:<em><%=FormatUtil.formatMoney(line.getRetifyAmount()) %></em></li>
				<li>费用说明:<em><%=line.getCostExplain()==null?"无":line.getCostExplain() %></em></li>
				<%
					}
				%>				
		  </ul>
...
$(function(){
	...
	if($("#AccountXXIDIOS").val()=='AccountXX') {
		$('.myAmount').show();
	}else{
		$('.myAmount').hide();
	}
