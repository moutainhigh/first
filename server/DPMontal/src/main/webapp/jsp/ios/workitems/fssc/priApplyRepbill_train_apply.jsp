    ...
    <div id="div2">
    	<div class="ulBox2">
    		<ul>
				...
				<li>是否借款:<em><%="y".equalsIgnoreCase(baseEntity.getIsLoan())? "是" : "否"%></em></li>
				...
				<li>报销主体:<em><%=baseEntity.getMainBodyName() == null ? "无" : baseEntity.getMainBodyName() %></em></li>
				<li>所属事业部:<em><%=baseEntity.getBusinessDept() == null ? "无" : baseEntity.getBusinessDept() %></em></li>
