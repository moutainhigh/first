...
<link rel="stylesheet" href="../../css/win8/common.css" />
<link rel="stylesheet" href="../../css/win8/list.css" />
...
<div id="list">
    ...
    <div id="div2">
    	<h3 class="yellow">通讯录</h3>
    	<div class="searchBox">
	    	<table>
	    		<tr>
	    			<td><input class="text" type="text" id="key" placeholder="请输入工号或姓名..." /></td>
	    			<td>
    	...
    	<div id="ulist_div" class="tableBox">
    		<div id="querydiv" style="color: #403b65">请查询...</div>
	    	<table style="width: 100%" id="ulist">
	        </table>
        </div>
...
$(function(){
	//点击事件开始
    $('#ulist tr').live("click",function(){
        var aid = $(this).attr("id");//全局变量赋值
        location.href = "<%=basePath%>/getAdressDetail?empid="+aid;
    });
