...
<link rel="stylesheet" href="<%=basePath %>/css/win8/login.css" />
	    ...
	    <div id="div2">
	    	<form action="logincheck" method="post" id="loginform" name="loginform">
		    	<table>
		            ...
		            <tr>
		            	<td colspan="2" style="text-align:right;overflow:hidden; ">
...
window.onload = function(){
	$(".logo").find("img").attr("src","<%=basePath%>/imgnews/win8/login_logo.jpg");
}
</script>
</html>
