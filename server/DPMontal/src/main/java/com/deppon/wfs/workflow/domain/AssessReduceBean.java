...
/**
 * @title: AssessreduceBean 
 * @description： 考核特批减免申请Bean
 * @author： wuyaqing
 * @date： 2013年10月21日 下午4:38:40
 */
/**
 * 命名空间
 */
public class AssessReduceBean implements Serializable {

	/**
	 * 序列号
	 */
	private static final long serialVersionUID = 3388789225144869014L;
	...
	/**
	 * @return the reduceType
	 */
	public String getReduceType() {
		return reduceType;
	}
	/**
	 * @param reduceType the reduceType to set
	 */
	...
	/**
	 * @param reserve3 the reserve3 to get
	 */
	...
	public int hashCode() {
		...
		//计算结果加上减免类别
		result = prime * result + ((reduceType == null) ? 0 : reduceType.hashCode());
		//计算结果加上备注1
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			...
			return false;
		//参数obj是该对象的一个引用
		AssessReduceBean other = (AssessReduceBean) obj;
		//该对象的applyPersonId为空
		if (applyPersonId == null) {
			//参数对象的applyPersonId不为空
		...
		if (createTime == null) {
			...
			//该对象的createTime与参数的createTime不相等
			//返回false
			return false;
		//该对象的isEffective为空
		if (isEffective == null) {
		...
		if (reduceType == null) {
			//参数的reduceType不为空
			if (other.reduceType != null)
				//返回false
				return false;
		} else if (!reduceType.equals(other.reduceType))
			//参数的reduceType与该对象的reduceType不相等
			//返回false
			return false;
		//该对象的reserve1为空
		if (reserve1 == null) {
