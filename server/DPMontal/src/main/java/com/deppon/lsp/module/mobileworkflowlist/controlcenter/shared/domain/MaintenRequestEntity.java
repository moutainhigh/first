...
public class MaintenRequestEntity extends BaseEntity {
    ...
    */
	public void setFnumber(String fnumber) {
		this.fnumber = fnumber==null?"":fnumber.trim();
	}
    ...
    */
	...
	public String getEndTimeStr() {
		return FormatUtil.formatDate(endTime, "yyyy-MM-dd");
	}
	/**
     * @return 申请事由
    */
    ...
    */
	public AdminOrgUnit getBelongProDept() {
		if (belongProDept == null) {
			belongProDept = new AdminOrgUnit();
		}
