...
//	日志接口URL地址
//	public static final String URL = "http://10.226.96.135:8080/bamp-web/ws/";
	//保存系统请求url
	public static String SYS_REQ_URL;
	//保存业务操作url
	public static String BUSI_OPER_URL;
	...
	//用户账号key
	public static final String EMPCODE = "EMP_CODE";
	//用户IP地址key
	...
	//调用接口密码value
	public static final String PWD = "Dp987239#88";
	//应用英文简称value
	public static final String APP_CODE = "DPM";
	...
	static {
	    ...
	    //初始化系统请求url
	    SYS_REQ_URL = InitDataServlet.getValue("bamp_sys_req_url");
//	    SYS_REQ_URL = JedisUtil.getValue("bamp_sys_req_url");
	    //初始化业务操作url
	    BUSI_OPER_URL = InitDataServlet.getValue("bamp_busi_oper_url");
//	    BUSI_OPER_URL = JedisUtil.getValue("bamp_busi_oper_url");
	}
	...
	public static String getMethodName() {
		...
		StringBuffer sb = new StringBuffer(new Exception().getStackTrace()[1].getClassName());
		//调用者的类名与方法名直接用.分割
