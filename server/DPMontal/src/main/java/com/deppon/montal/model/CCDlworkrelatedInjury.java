...
import com.deppon.montal.conf.F_Constants;
   ...
   /** 
   * @ClassName: CCDlworkrelatedInjury 
   * @Description:(工伤医疗费用报销申请实体类)
   * @TabelName:CC_DLWORKRELATEDINJURY
   * @author 廖建雄 
   * @date 2013-6-5 下午4:03:45 
   * 
   */
public class CCDlworkrelatedInjury {
    ...
    public String getInjurydept() {
        return F_Constants.chageNull(injurydept);
    }
    ...
    public String getInjurycompany() {
        return F_Constants.chageNull(injurycompany);
    }
