 ...
 * @version V1.0 
 */
public class GetBenifitFeeEntryAction extends AppDelegateAction {
	...
	private static final long serialVersionUID = 5360692117117609005L;
	@Override
	protected void response() {
		...
		List<CCwelfareexpenseEntry> welfareexpenses = service.getCCwelfareexpenseEntry(workID);
		StringBuffer empHtml = new StringBuffer();
		if(null != ui_type && ui_type.equals(F_Constants.UI_IOS)){
		    int index = 0;
		    for (CCwelfareexpenseEntry entry : welfareexpenses) {
			if(index == 0){
