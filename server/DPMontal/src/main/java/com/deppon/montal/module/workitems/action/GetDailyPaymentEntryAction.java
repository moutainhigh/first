...
import com.deppon.montal.module.workitems.service.IPodailyPaymentService;
import com.deppon.montal.module.workitems.service.PodailyPaymentService;
   /** 
 ...
 * @version V1.0 
 */
public class GetDailyPaymentEntryAction extends AppDelegateAction {
	...
	List<CCPodailyPaymentEntry> paymentEntrys = service.getCCPodailyPaymentEntry(workId);
	...
	if(null != ui_type && ui_type.equals(F_Constants.UI_IOS)){
	    int index = 0;
	    for (CCPodailyPaymentEntry entry : paymentEntrys) {
		if(index == 0){
