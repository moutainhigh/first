...
import com.deppon.montal.module.workitems.service.IRentService;
import com.deppon.montal.module.workitems.service.RentService;
   /** 
 * @Title: GetRentEntryAction.java
 * @Package com.deppon.montal.module.workitems.action 
 ...
 * @version V1.0 
 */
public class GetRentEntryAction extends AppDelegateAction {
	   /**
	    * @Fields serialVersionUID : TODO(用一句话描述这个变量表示什么)
	   */
	
	private static final long serialVersionUID = -5022897038949308135L;
	...
	protected void response() {
		...
		List<CCPorentEntry> rentEntries = service.queryRentEntryByWorkId(workID);
		StringBuffer empHtml = new StringBuffer();
		if(null != ui_type && ui_type.equals(F_Constants.UI_IOS)){
		    int index = 0;
		    for (CCPorentEntry entry : rentEntries) {
			if(index == 0){
