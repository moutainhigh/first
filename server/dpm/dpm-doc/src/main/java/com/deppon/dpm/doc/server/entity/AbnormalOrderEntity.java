...
public class AbnormalOrderEntity {
	/**
	 * 构造方法
	 */
	public AbnormalOrderEntity(){
		super();
	}
	//主键
	private String id ;
	...
	//会议图片拆分数组
	private String[] meetingPicArray;
	...
	/**
	 * @param errorrule the errorrule to set
	 */
	...
	public String[] getMeetingPicArray() {
		return meetingPicArray;
	}
	public void setMeetingPicArray(String[] meetingPicArray) {
		this.meetingPicArray = meetingPicArray;
	}
