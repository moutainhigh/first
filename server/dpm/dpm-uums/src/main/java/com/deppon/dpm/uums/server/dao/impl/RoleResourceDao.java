...
public class RoleResourceDao extends SqlSessionDaoSupport implements
	IRoleResourceDao {
	private static final Logger LOGGER = LoggerFactory.getLogger(RoleResourceDao.class);
    private static final String NAMESPACE = "com.deppon.dpm.uums.server.dao.roleResourceMapper.";
	...
	entity.setActive(Constants.ACTIVE_YES);
	int result = getSqlSession().insert(NAMESPACE + "addRoleResource", entity);
	return result > Constants.ZERO ? entity : null;
    }
	...
	entity.setActive(Constants.ACTIVE_NO);
	
	Map<String, Object> map=new HashMap<String, Object>();
	map.put("entity", entity);
	// 只删除active为有效的：
	map.put("conditionActive", Constants.ACTIVE_YES);
	...
	if (CollectionUtils.isEmpty(entitys)) {
	    ...
	    return entitys.get(Constants.ZERO);
	}
    }
	...
	Map<String,Object> map = new HashMap<String , Object>();
	map.put("codes", codes);
	map.put("active", Constants.ACTIVE_YES);
	...
	queryEntity.setActive(Constants.ACTIVE_YES);
	...
	return retnFlag > Constants.ZERO ? entity : null;
    }
     ...
     * @date 2012-10-25 下午3:27:19
     */
    public RoleResourceEntity deleteRoleResourceByResourceCode(RoleResourceEntity entity){
    	if(null == entity|| StringUtil.isBlank(entity.getResourceCode())){
    		return null;
    	}
    	entity.setActive(Constants.ACTIVE_NO);
    	...
    	int retnFlag = this.getSqlSession().update(
    			NAMESPACE + "deleteRoleResourceByResourceCode", map);
    	return retnFlag > Constants.ZERO ? entity : null;
    }
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<RoleResourceEntity> queryRoleResourceExactByRoles(
			List<String> roles) {
		// 构建参数
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("active", Constants.ACTIVE_YES);
		...
		return getSqlSession().selectList(NAMESPACE + 
				"queryRoleResourceExactByRoles",map);
	}
