...
public class EmployeeDao extends iBatis3DaoImpl implements IEmployeeDao {
	 ...
	 * @return
	 */
	public EmployeeVO getInfoByEmpcode(String empcode){
		return (EmployeeVO)this.getSqlSession().selectOne(NAMESPACE + "getInfoByEmpcode", empcode);
	}
...
//				+ userIds + ")";
	...
	public List<String> getUserIdsByLowVersion(){
		List<String> list = getSqlSession().selectList(NAMESPACE + "getUserIdsByLowVersion");
		return list == null ? new ArrayList<String>():list;
	}
	 ...
	 */
	@Override
	public EmployeeVO queryLeave(EmployeeVO emp) {
		// 数据库查询返回值
		return (EmployeeVO) this.getSqlSession().selectOne(NAMESPACE + "getLeaveEmp", emp);
	}
	 ...
	 */
	@Override
	public int insertLeaveEmp (EmployeeVO emp) {
		// 数据库查询返回值
		return  this.getSqlSession().insert(NAMESPACE + "insertLeaveEmp", emp);
	}
     ...
     */
	@Override
	public EmployeeVO queryLeaveEmpMessage(EmployeeVO emp) {
		return (EmployeeVO) this.getSqlSession().selectOne(NAMESPACE + "getLeaveEmpMessage", emp);
