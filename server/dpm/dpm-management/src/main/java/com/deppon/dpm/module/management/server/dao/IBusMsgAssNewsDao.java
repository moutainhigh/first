...
public interface IBusMsgAssNewsDao {
	 ...
	 */
	public List<BusOpenLineEntity> findHits(BusOpenLineEntity msgBean) throws BusinessException;
	/** 
	 * <p>保存点击量</p> 
	 * @author xieyidong
	 ...
	 */
	public List<BusNewsSiteEntity> getSiteId(BusNewsSiteEntity msgBean) throws BusinessException;
	/** 
	 * <p>首次新增站点插入开线建议表</p> 
	 * @author xieyidong
	 ...
	 * @see
	 */
	public int deleteReplyMsg(int msgBean) throws BusinessException;
	/* 
	 ...
	 */
	public int saveEvaluateManage(BusEvaluationManageEntity msgBean) throws BusinessException;
	/* 
	 ...
	 * @see com.deppon.dpm.module.management.server.dao.IBusMsgAssNewsDao#getSiteId(com.deppon.dpm.module.management.shared.domain.BusNewsSiteEntity)
	 */
	public List<BusNewsSiteEntity>  getRepeSiteId(BusNewsSiteEntity msgBean) throws BusinessException;
	/* (non-Javadoc)
	 ...
	 */
	public List<BusEvaluationManageEntity> getEvaManage(BusEvaluationManageEntity msgBean) throws BusinessException;
	/* (non-Javadoc)
