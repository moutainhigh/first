...
public class ProcMainService implements IProcMainService {
	...
	public ResultVO<Object> postMessage(ProcMaintainEntity entity) throws HttpException, IOException {
	 ...
	 * @throws HttpException 
	 */
	public JSONObject getMessageForPCByHttp(String json,String url,String esbServiceCode) throws BusinessException, HttpException, IOException{
