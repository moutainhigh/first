...
//				ProcSurveyMsg procSurveyMsg3 = null;
				...
				for (int i = 0; i < strList.size(); i++) {
					...
					//for 循环进行判断
					//抽取方法
					setSurveyMsg2(listMsg, strList, listMsgId, i, list2,
							listMsgs);
	...
	public void setSurveyMsg2(List<ProcSurveyMsg> listMsg,
			List<String> strList, List<String> listMsgId, int i,
			List<ProcSurveyMsg> list2, List<ProcSurveyMsg> listMsgs) {
		ProcSurveyMsg procSurveyMsg2;
		ProcSurveyMsg procSurveyMsg3;
