...
public class BusManagerDao extends iBatis3DaoImpl implements IBusManagerDao {
	 ...
	 *             抛出异常
	 */
	public int updateStation(BusLineOfSite busSite) throws BusinessException {
	 ...
	 *             抛出异常
	 */
	public int updateLineInfo(BusLineInfo lineInfo) throws BusinessException {
	 ...
	 *             抛出异常
	 */
	public int saveLineInfo(BusLineInfo lineInfo) throws BusinessException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<BusLineInfo> listLineInfo(BusLineInfo busInfo) throws BusinessException {
		return this.getSqlSession().selectList(
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<BusCentreAdviceEntity> getCentreData() throws BusinessException {
		return this.getSqlSession().selectList(
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<BusFormBeanEntity> getOpenAdviceData(int id) throws BusinessException {
		if (id > 0) {
			return this.getSqlSession().selectList(
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<BusFormBeanEntity> getEvaFormBeanData(int id) throws BusinessException {
		if (id > 0) {
			return this.getSqlSession().selectList(
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<BusUserEntity> getUserData(String userNo) throws BusinessException {
		if (null != userNo) {
			return this.getSqlSession().selectList(
	 ...
	 *             抛出异常
	 */
	public int getMaxLineId() throws BusinessException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<BusLineOfSite> listSite(int lineId) throws BusinessException {
		if (lineId > 0) {
			return this.getSqlSession().selectList(
	 ...
	 *             抛出异常
	 */
	public int saveLineSite(BusLineOfSite lineOfSite) throws BusinessException {
	 ...
	 *             抛出异常
	 */
	public int delOpenLineReply(int id) throws BusinessException {
		if (id > 0) {
	 ...
	 *             抛出异常
	 */
	public int delManageReply(int id) throws BusinessException {
		if (id > 0) {
			return this.getSqlSession().delete(
