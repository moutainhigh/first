...
public interface IMailReceiveSendFunctionDao{
	 ...
	 */
	public int updatePackageRec(List<MailReceiveSendFunctionEntity> parList) throws BusinessException;
	/* 查询是本人签收还是代签
	 * (non-Javadoc)
	 * @see com.deppon.dpm.module.management.server.dao.IMailReceiveSendFunctionDao#selectPackageRec(java.util.List)
	 */
	public List<MailReceiveSendFunctionEntity> selectPackageRec(List<MailReceiveSendFunctionEntity> parList) throws BusinessException;
	/* 更新状态为签收 (非本人)
	 * (non-Javadoc)
	 * @see com.deppon.dpm.module.management.server.dao.IMailReceiveSendFunctionDao#updateUnOneself(java.util.List)
	 */
	public int updateUnOneself(List<MailReceiveSendFunctionEntity> parList) throws BusinessException;
	/* 保存代签人信息
	 * (non-Javadoc)
	 * @see com.deppon.dpm.module.management.server.dao.IMailReceiveSendFunctionDao#insertUnUser(java.util.List)
	 */
	public int insertUnUser(List<MailReceiveSendFunctionEntity> parList) throws BusinessException;

	/* 包裹拒收
	 * (non-Javadoc)
	 * @see com.deppon.dpm.module.management.server.dao.IMailReceiveSendFunctionDao#updatePackageOut(java.util.List)
	 */
	public int updatePackageOut(List<MailReceiveSendFunctionEntity> parList) throws BusinessException;
	/* 包裹注销
	 * (non-Javadoc)
	 * @see com.deppon.dpm.module.management.server.dao.IMailReceiveSendFunctionDao#updatePackageReject(java.util.List)
	 */
	public int updatePackageReject(List<MailReceiveSendFunctionEntity> parList) throws BusinessException;

	/* 包裹催领
	 * (non-Javadoc)
	 * @see com.deppon.dpm.module.management.server.dao.IMailReceiveSendFunctionDao#updatePackageCorporal(java.util.List)
	 */
	public int updatePackageCorporal(List<MailReceiveSendFunctionEntity> parList) throws BusinessException;
	 ...
	 */
	public int updatePackageNativeRec(MailReceiveSendFunctionEntity parList) throws BusinessException;
