 ...
 *
 */
public class AppPermissionAction extends BaseAction{
	/**
	 * 应用权限表
	 */
	 ...
	 * 日志
	 */
	private static Logger logger  = LoggerFactory.getLogger(AppPermissionAction.class);
	
	//@CookieNotCheckedRequired
	/*public void isHaveAppPermission(){
