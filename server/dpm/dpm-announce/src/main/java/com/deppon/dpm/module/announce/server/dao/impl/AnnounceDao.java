...
public class AnnounceDao extends iBatis3DaoImpl implements IAnnounceDao {
	...
	* @throws
	...
	public List<String> getAnnounceTypes(){
		return getSqlSession().selectList(NAME_SPACE + "getAnnounceTypes");
	...
	public List<AnnounceEntity> getAnnouncesByType(String type) {
		...
		return getSqlSession().selectList(NAME_SPACE + "getAnnouncesByType",type);
	}
	...
	public int updateBatch4Path(List<AnnounceEntity> list) {
		return getSqlSession().update(NAME_SPACE + "updateBatch4Path", list);
	}
}