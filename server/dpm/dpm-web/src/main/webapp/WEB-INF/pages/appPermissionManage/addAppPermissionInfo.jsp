	...
	<form id="addContent" method="post">
	    <table cellpadding="5">
	        <tr>
	            <td>应用编号:</td>
	            <td>
	            	<input class="easyui-numberbox" type="text" name="appid" data-options="min:0,max:100000000,precision:0,required:true" style="width: 280px;"></input>
	            	<input type="hidden" name="operation" value="save">
	            </td>
	        </tr>
	        <tr>
	            <td>部门编号:</td>
	            <td><input class="easyui-numberbox" type="text" name="orgid" data-options="min:0,max:100000000,precision:0,required:true" style="width: 280px;"></input></td>
	        </tr>
	        <tr>
	            <td>工号:</td>
