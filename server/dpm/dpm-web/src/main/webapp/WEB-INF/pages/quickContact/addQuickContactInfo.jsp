	...
	<form id="addContent" method="post">
	    <table cellpadding="5">
	        <tr>
	            <td>姓名:</td>
	            <td>
	            	<input class="easyui-textbox" type="text" id="empName" name="empName" data-options="validType:'length[0,30]',required:true" style="width: 280px;"></input>
	            	<input type="hidden" name="operation" value="save">
	            </td>
	        </tr>
	        <tr>
	            <td>工号:</td>
	            <td><input class="easyui-textbox" type="text" id="empCode" name="empCode" data-options="validType:'length[0,30]',required:true" style="width: 280px;"></input></td>
	        </tr>
	        <tr>
	            <td>内容:</td>
	            <td><input class="easyui-textbox" type="text" id="Content" name="Content" data-options="validType:'length[0,100]',required:true" style="width: 280px;"></input></td>
	        </tr>
	    </table>
	</form>
