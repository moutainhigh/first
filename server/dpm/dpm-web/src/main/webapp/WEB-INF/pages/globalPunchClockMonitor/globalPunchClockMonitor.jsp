...
<script type="text/javascript">
	$(function(){
		...
		$("#grid").datagrid({
			...
			columns:[[{
				...
				pageSize:20,
				pageList:[20,30,50],
				url:'${pageContext.request.contextPath}/dpmManage/autoPunchClockMonitorGlobalPc_queryByPage.action',
	...
	function statusFormat(val,row){
		...
		return val == 1  ? '<span style="color: green">成功</span>' : '<span style="color: red">失败</span>';
	}
