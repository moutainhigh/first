...
<body>
    <table class="easyui-datagrid" id="appPermissionInfoList"
	       data-options="singleSelect:false,pagination:true,url:'/dpm/dpmManage/locationPermissionPc_list.action',method:'get',pageSize:10,toolbar:toolbar,pageList:[5,10,20]
...
<div id="appPermissionInfoAdd" class="easyui-window" title="新增" data-options="modal:true,closed:true,iconCls:'icon-save',href:'/dpm/dpmManage/locationPermissionPc_toPage.action?pageType=toAddPage'" style="width:600px;height:300px;padding:10px;">
        The window content.
</div>
<div id="appPermissionInfoEdit" class="easyui-window" title="编辑" data-options="modal:true,closed:true,iconCls:'icon-edit',href:'/dpm/dpmManage/locationPermissionPc_toPage.action?pageType=toEditPage'" style="width:600px;height:300px;padding:10px;">
        The window content.
</div>
    ...
    handler:function(){
    	...
    	$.messager.confirm('确认','确定删除ID为 '+ids+' 的信息吗？',function(r){
    	    if (r){
    	    	...
    	    	$.ajax({
    				   type: "POST",
    				   url: "/dpm/dpmManage/locationPermissionPc_delete.action",
    				   data: {'ids':ids},
