...
public class MagicNumber {
	// 数字0.1
	public static final double DOUBLENUM1 = 0.1;
	// 数字-8
	public static final int NUMNEGATIVE8 = -8;
	// 数字-1
	public static final int NUMNEGATIVE1 = -1;
	// 数字0
	...
	// 数字97
	public static final int NUM97 = 97;
	// 数字100
	public static final int NUM100 = 100;
	// 数字100
	public static final int NUM104 = 104;
	// 数字170
	...
	// 数字368
	public static final int NUM368 = 368;
	// 数字373
	public static final int NUM373 = 373;
	// 数字377
	public static final int NUM377 = 377;
	// 数字379
	public static final int NUM379 = 379;
	// 数字380
	public static final int NUM380 = 380;
	// 数字380
	public static final int NUM381 = 381;
	// 数字384
	public static final int NUM384 = 384;
	// 数字387
	public static final int NUM387 = 387;
	// 数字400
	public static final int NUM400 = 400;
	// 数字443
	public static final int NUM443 = 443;
	// 数字400
	public static final int NUM412 = 412;
	// 数字416
	public static final int NUM416 = 416;
	// 数字425
	public static final int NUM425 = 425;
	// 数字443
	public static final int NUM421 = 421;
	// 数字500
	...
	// 数字1800(30分钟)
	public static final int NUM1800 = 1800;
	// 数字3000
	...
	// 数字7200
	public static final int NUM7200 = 7200;
	// 数字8192
	public static final int NUM8192 = 8192;
	// 数字10000
	public static final int NUM10000 = 10000;
	// 数字15000
	public static final int NUM15000 = 15000;
	// 数字30000
	public static final int NUM30000 = 30000;
	// 数字36000
	public static final int NUM36000 = 36000;
	// 数字60000
	...
	// 数字899999
	public static final int NUM899999 = 899999;
	// 数字259200(72小时)
	public static final int NUM259200 = 259200;
}
