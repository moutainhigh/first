...
public class DppmReportService implements IDppmReportService {
	 ...
	 * @return
	 */
	public static final int NUMBER_OF_NINE = 9;
	public static final int NUMBER_OF_NUMBER1 = 200000;
	public static final int NUMBER_OF_NUMBER2 = 180000;
	public static final int NUMBER_OF_NUMBER3 = 443;
...
//		EmployeeEntity e = login.getData().getUserEntity().getEmployee();
		...
		if (jobLevel != null && !jobLevel.equals("") && (jobLevel.equals("C") || jobLevel.equals("D") || Integer.parseInt(jobLevel) > NUMBER_OF_NINE)){
...
//		String json = "{\"d\":\"d\"}";
	 ...
	 * @return
	 */
	public String powerReport(String userId) throws BusinessException {
		// 定义map 变量
	...
	public String restfulWork(String uri,String esbCode, String json) {
		...
		try {
			...
			// 设置连接超时时间(单位毫秒)
			managerParams.setConnectionTimeout(NUMBER_OF_NUMBER1);
			// 设置读数据超时时间(单位毫秒)
			managerParams.setSoTimeout(NUMBER_OF_NUMBER2);
			Protocol myhttps = new Protocol("https",
					new MySSLProtocolSocketFactory(), NUMBER_OF_NUMBER3);
