...
public  class SqlUtil {
	...
	/**项目审核检查日志*/
	public static String getAuditChecklog(String taskid,String checkDesc, int checkStatus ){
		return "insert into dotp_tm_task_check_log(task_id,check_desc,check_time,check_status) values("+taskid+",'"+checkDesc+"',"+"NOW()"+","+checkStatus+")";
	}
	/**项目审核日志*/
