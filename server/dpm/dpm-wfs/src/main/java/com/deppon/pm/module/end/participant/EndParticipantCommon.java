...
public class EndParticipantCommon {
	 ...
	 * @see
	 */
	public BpmsParticipant[] getProjectManager(ParticipantRule rule,Map<?,?> params) {
	 ...
	 * @see
	 */
	public BpmsParticipant[] getGroundOverTakenAndIT(ParticipantRule rule,Map<?,?> params) {
	 ...
	 * @see
	 */
	public BpmsParticipant[] getGroundOverTakenAndDA(ParticipantRule rule,Map<?,?> params) {
	 ...
	 * @see
	 */
	public BpmsParticipant[] getBusinessCheckManager(ParticipantRule rule,Map<?,?> params) {
	 ...
	 * @see
	 */
	public BpmsParticipant[] getModuleCheckManager(ParticipantRule rule,Map<?,?> params) {
	 ...
	 * @see
	 */
	public BpmsParticipant[] getProjectClosingManager(ParticipantRule rule,Map<?,?> params) {
