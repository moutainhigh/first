	...
	*/
	...
	public void queryWorkInfo() {
		...
		try {
			...
			//结项工作流查看
			if( this.type == Constants.CONSTANT_ONE) {
				// 调用service 获得结项工作流详情
