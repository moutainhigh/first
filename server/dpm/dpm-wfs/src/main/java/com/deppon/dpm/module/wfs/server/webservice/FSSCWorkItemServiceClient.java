...
//        System.out.println(client+"ccccccccccccccccc");
	 ...
	 */
	public static Object getFSSCWorkItemInfo(Object[] args,String uri) throws ServletException {
...
//	        }
			...
			throw new ServletException("获取报账系统业务数据异常，当前工作流信息：【报账单号："+args[0]+" 当前审批人:"+args[1]+"  工作项ID:" + args[2]+"】,异常信息："+e.getMessage(), e);
		}
	}
