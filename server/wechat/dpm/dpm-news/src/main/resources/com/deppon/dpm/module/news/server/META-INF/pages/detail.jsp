					...
					function($scope, $http) {
                        ...
                        if(isBan==1){
                            if(confirm('收件人含高层领导，请仔细确认，谨慎发送')){
                                ...
                                window.location.href = "/dpm/push.action?back=1";
                            }else{
                                var  compont = '';
                            }
                        }else{
						...
						$("#breadCast").click(function() {
							window.location.href = "/dpm/push.action?back=2";
						})
						//已选人员全选
...
<body ng-controller="MyDetail">
	<div class="container" style="margin-top: 50px">
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-offset-3" id="link2">
				<ul class="pagination">
