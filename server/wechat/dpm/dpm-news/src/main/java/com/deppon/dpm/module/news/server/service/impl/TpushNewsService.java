	...
	public boolean isSend(String empCode, int type) {
		...
		if (StringUtils.isNotEmpty(applySort)) {
			...
			while (tokenizer.hasMoreElements()) {
				...
				// 工资条
//				if (appId == DpmConstants.wage
//						&& type == DpmConstants.TPUSH_WAGE) {
//					return true;
//					// HR自助
//				} else if (appId == DpmConstants.talentSelection
//						&& type == DpmConstants.TPUSH_HR_HELP) {
//					return true;
//					// 固定资产
//				} else if (appId == DpmConstants.fixedAssets
//						&& type == DpmConstants.TPUSH_FIXED_ASSETS) {
//					return true;
//					// IT服务台
//				} else if (appId == DpmConstants.itPlatform
//						&& type == DpmConstants.TPUSH_IT_PLATFORM) {
//					return true;
//					// 我的任务
//				} else if (type == DpmConstants.TPUSH_MY_TASK) {
//					return true;
//					// 工作流
//				} else if (type == DpmConstants.TPUSH_WORK_FLOW) {
//					return true;
//					// 差旅助手
//				} else if (appId == DpmConstants.travelAssistant
//						&& type == DpmConstants.TPUSH_TRAVEL_ASSISTANT) {
//					return true;
//					// 工程管理
//				} else if (appId == DpmConstants.projectManage
//						&& type == DpmConstants.TPUSH_PROJECT_MANAGMENT) {
//					return true;
//					// 收发室
//				} else if (appId == DpmConstants.inOut
//						&& type == DpmConstants.TPUSH_IN_OUT) {
//					return true;
//					// 德邦E站
//				} else if (type == DpmConstants.TPUSH_DEPPON_E) {
//					return true;
//					// 发现
//				} else if (appId == DpmConstants.discovery
//						&& type == DpmConstants.TPUSH_DISCOVERY) {
//					return true;
//					// crm
//				} else if (appId == DpmConstants.crm
//						&& type == DpmConstants.TPUSH_CRM) {
//					return true;
//					// BI
//				} else if (type == DpmConstants.TPUSH_BI) {
//					return true;
//					// 早安快递
//				} else if (appId == DpmConstants.express
//						&& type == DpmConstants.TPUSH_EXPRESS_VISUALIZE) {
//					return true;
//					// 在线学习 微课堂
//				} else if (appId == DpmConstants.learning_online
//						&& type == DpmConstants.TPUSH_LEARNING_ONLINE) {
//					return true;
//					// 场地预定
//				} else if (appId == DpmConstants.venue_booking
//						&& type == DpmConstants.TPUSH_VENUE_BOOKING) {
//					return true;
//					// 项目管理
//				} else if (type == DpmConstants.TPUSH_DPPM) {
//					return true;
//					// 后勤服务
//				} else if (type == DpmConstants.TPUSH_B_S) {
//					return true;
//					// 人事服务
//				} else if (type == DpmConstants.TPUSH_NHR) {
//					return true;
//				}
			}
		}
