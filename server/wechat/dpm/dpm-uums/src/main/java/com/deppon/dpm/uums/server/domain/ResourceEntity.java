...
public class ResourceEntity extends BaseEntity implements IFunction,Serializable {
    ...
    */
     ...
     * 父类的IDString版本
     */
    private String parentResString;
	...
	/** 
	 * @return parentResString 
	 */
	public String getParentResString() {
		return parentResString;
	}

	/** 
	 * @param parentResString 要设置的 parentResString 
	 */
	public void setParentResString(String parentResString) {
		this.parentResString = parentResString;
	}
}
