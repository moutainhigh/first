...
public interface IBranchRuleManagerService {
	 ...
	 */
	boolean projectTypeIsDevelopment(Map map)  throws Exception;
	 ...
	 * @see com.deppon.pm.module.end.branch.service.IBranchRuleManagerService#getProjectType(java.util.Map)
	 */
	boolean projectLevelIsStrategy(Map map)  throws Exception;
	/**
	 * <p>落地判断战略</p> 
	 * @author 106140
	 ...
	 * @see
	 */
	boolean levelIsStrategyGround(Map map)  throws Exception;
}
