...
//	}
	...
	public List<OaWorkItem> workitemslist(WorkItemsDto dto) {
		...
		builder.append("CASE WHEN B.PARTICIPANT='" + dto.getUserId() + "'");
		...
		builder.append("b.starttime starttime,");
		builder.append(" A.SYSCODE,");
		builder.append(" CASE WHEN WI.PARTICIPANTID='" + dto.getUserId() + "'");
		...
		builder.append(") BB left join dipoa.dpmon_workflow d on bb.flowtype=d.workflowname ");
