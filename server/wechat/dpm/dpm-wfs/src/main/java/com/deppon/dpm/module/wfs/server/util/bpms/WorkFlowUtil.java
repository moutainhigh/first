...
public class WorkFlowUtil {
	 ...
	 * @see
	 */
	public static List<ApprovalInfo> getApprovalInfo(long processinstId, String empCode, String empName) throws Exception {
		//调用工作流API取到已处理的工作流单号
	...
	* @return boolean
	 */
	public static boolean approvalWorkFlow(IDpBpmsClientFacade dpBpmsClientFacade,ApprovelEntity approvelEntity) throws Exception {
