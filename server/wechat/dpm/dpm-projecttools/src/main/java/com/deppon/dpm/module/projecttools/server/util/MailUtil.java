...
public class MailUtil {
    ...
    public static void sendMail(String[] toEmail, String subject,
        ...
        logger.info("新增跟踪日志提交邮件提醒发送成功-------"+htmlContent);

    }

//    public static void main(String[] args) {
//    	String[] toEmail={"gaochunling@deppon.com"};
//    	MailUtil.sendMail(toEmail, "xxx","xxx", "mail.deppon.com","gaochunling@deppon.com","gaochunling@deppon.com","GAO1990");
//    	
//    }
}
