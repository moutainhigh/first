...
public class ProcCheckFindScoreShowService implements IProcCheckFindScoreShowService{
	...
	private Map<String, List<ProcCheckScoreEntity>> parseSocreList(
			List<ProcCheckScoreEntity> socreList) throws Exception{
	...
	public String getFindListView(String str) throws Exception {
	  ...
	  //设置参数
		...
		*/
		if(socreList.size() == 1 && "[null]".equals(socreList.get(0)) || socreList.size() == 0){
	...
	private void checkHisPointsList(ProcCheckScoreEntity parBean) throws Exception{
