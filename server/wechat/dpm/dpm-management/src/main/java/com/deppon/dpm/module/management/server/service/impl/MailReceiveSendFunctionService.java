...
public class MailReceiveSendFunctionService implements IMailReceiveSendFunctionService{
	 ...
	 */
	@Override
	public String updateRecInfo(String str) throws Exception {
	...
	private String updateRecState(int postStatus,int parcelState,String userNo,String userName,long packageId) throws Exception {
		int result = -1;
		//更新数据库里的参数
	 ...
	 * @return
	 */
	private MailReceiveSendFunctionEntity toPcUpdateInfo(MailReceiveSendToPCEntity parBeanPC) throws Exception{
