...
public class ReserveManageQueryListInfoService implements
	 ...
	 * @return
	 */
	private ReserveRecordEntity parseDate(ReserveRecordEntity parBean) throws Exception{
...
*/		String dateStr = parBean.getDateStr();//yyyy-MM-dd
	 ...
	 * @throws Exception
	 */
	private ReserveRecordEntity setParBeanSiteDate(int id, String dateStr) throws Exception{
		SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
		ReserveRecordEntity parBean = new ReserveRecordEntity();
		parBean.setId(id);
	 ...
	 * @return
	 */
	public boolean checkSuperAdmin(String userNo) throws Exception{
