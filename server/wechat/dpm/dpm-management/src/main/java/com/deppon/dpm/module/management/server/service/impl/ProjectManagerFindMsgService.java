...
public class ProjectManagerFindMsgService implements
	...
	@Override
	public String getProjectMsg(String str) throws Exception {
	...
	private List<BaseQualityPollingEntity> setProcCountInfo (
			String fcheckAreaCode, List<BaseQualityPollingEntity> resultHis) throws Exception{
		// 统计量的匹配
	...
	private List<BaseQualityPollingEntity> setHistoryInfo(
			...
			String proAdress, String userNo) throws Exception{
		// 获取历史评分记录
	...
	private Map<String, List<BaseQualityPollingEntity>> getGradeMap(
			List<BaseQualityPollingEntity> fcheckProjects) throws Exception{
	...
	private synchronized List<BaseQualityPollingEntity> getFcheckProjects (
			String fcheckAreaCode) throws Exception{
	 ...
	 * @return
	 */
	private int getzeroScore(String proAdress, String userNo) throws Exception {
		// 获取门店地址的0分项
	 ...
	 * @throws Exception
	 */
	private int getScore(String proAdress, String userNo) throws Exception {
		ProjectManagerFindMsgEntity msgBean = new ProjectManagerFindMsgEntity();
		log.info("getScore_proAdress:" + proAdress);
		log.info("getScore_userNo:" + userNo);
		msgBean.setProAdress(proAdress);
	 ...
	 * #getParserInfo()
	 */
	public String getParserInfo() throws Exception {
	...
	public String requestToPcClient(Map<String, Object> param, String url,
			String esbServiceCode) throws Exception {
	 ...
	 */
	@Override
	public String getSigHistoryInfo(String str) throws Exception {
		String res = "{\"resultFlag\":false,\"failureReason\":\"查询失败\"}";
	 ...
	 */
	@Override
	public String setToPcRecord(String str) throws Exception {
		...
		String proAdress = json.getString("proAdress").trim();
		// 定位地址
		String streetAddress = json.getString("streetAddress") == null ? ""
				: json.getString("streetAddress").trim();
		// 用户工号
		String userNo = json.getString("userNo").trim();
		// 项目编码
		String proNumber = json.getString("proNumber") == null ? "" : json
				.getString("proNumber").trim();
		// 备注
		String mark = json.getString("mark") == null ? "" : json.getString(
				"mark").trim();
		log.info(mark);
		log.info(proAdress);
		log.info(userNo);
		...
		if(deptCode == null || "".equals(deptCode)){
			return "{\"resultFlag\":false,\"failureReason\":\"传入的标杆编码(deptCode)为空\",\"isSubmit\":\"unsuccessful\"}";
		}
		if (proAdress == null || "".equals(proAdress) || userNo == null
				|| "".equals(userNo)) {
			return "{\"resultFlag\":false,\"failureReason\":\"传入的参数为NULL\",\"isSubmit\":\"unsuccessful\"}";
		}
	...
	private String submitPollingAndMaintain(String streetAddress, String mark,
			...
			List<ProjectManagerFindMsgEntity> empList) throws Exception{
		// 提交巡检表
	 ...
	 * @throws Exception
	 */
	private int saveHisSubmit(String proAdress, String userNo) throws Exception {
	 ...
	 */
	@Override
	public synchronized String checkSubmit(String str) throws Exception {
