...
public class BusManagerService implements IBusManagerService {
	...
	public String updateStation(BusLineOfSite busSite) throws Exception {
		String res = "";
		if (null != busSite) {
			//update 数据
	 ...
	 *             抛出异常
	 */
	public String updateLineTime(BusLineInfo lineInfo) throws Exception {
		String res = "";
		if (null != lineInfo) {
            //更新线路
	...
	public String saveLineInfo(BusLineInfo lineInfo) throws Exception {
		String res = "";
		if (null != lineInfo) {
	 ...
	 *             抛出异常
	 */
	public String getEvaManData() throws Exception {
	 ...
	 *             抛出异常
	 */
	public String getHistoryData(String userNo) throws Exception {
	 ...
	 *             抛出异常
	 */
	public BusFormBeanEntity getEvaFormBeanData(int id) throws Exception {
		if (id > 0) {
	 ...
	 *             抛出异常
	 */
	public BusFormBeanEntity getAdviceFormBeanData(int id) throws Exception {
		if (id > 0) {
			List<BusFormBeanEntity> listBean = this.busManagerDao
	...
	public String delReply(BusFormBeanEntity beanEntity) throws Exception {
