...
public class AssetStockService implements IAssetStockService{
	 ...
	 */
	@Override
	public List<StockTaskingEntity> getStockTaskNumber(Map<String, Object> map) throws Exception{
	 ...
	 */
	@Override
	public List<StockByEndDateEntity> queryGroupByEndDate(Map<String, Object> map) throws Exception {
	...
	public String submitOrStorage(String  info) {
		...
		Map<String, Object> map=new HashMap<String, Object>();
			...
			logger.error("submitOrStorage--------提交或暂存失败",e);
 			e.printStackTrace();
...
//			}
	 ...
	 */
	@Override
	public PushAssetClearScrapeEntity getAssetDetails(String fnumber) throws Exception {
