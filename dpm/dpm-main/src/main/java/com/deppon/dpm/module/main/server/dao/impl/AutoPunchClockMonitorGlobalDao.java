 ...
 * 自动打卡监控dao
 */
public class AutoPunchClockMonitorGlobalDao extends iBatis3DaoImpl implements IAutoPunchClockMonitorGlobalDao{

	// NAME_SPACE
	private static final String NAME_SPACE = "com.deppon.dpm.module.main.server.dao.impl.AutoPunchClockMonitorGlobalDao.";
