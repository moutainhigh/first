...
public class AutoPunchClockMonitorAction extends BaseAction implements ModelDriven<AutoPunchClockMonitorEntity>{

	private static final Logger LOG = LoggerFactory.getLogger(AutoPunchClockMonitorAction.class);
	
	// 构建实体对象
	private AutoPunchClockMonitorEntity entity = new AutoPunchClockMonitorEntity();
	
	// service
	private IAutoPunchClockMonitorService autoPunchClockMonitorService;
	...
	public void setAutoPunchClockMonitorService(
			IAutoPunchClockMonitorService autoPunchClockMonitorService) {
