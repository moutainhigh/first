...
<body>
    <table class="easyui-datagrid" id="appPermissionInfoList"
	       data-options="singleSelect:false,pagination:true,url:'/dpm/dpmManage/appPermissionPc_list.action',method:'get',pageSize:10,toolbar:toolbar,pageList:[5,10,20]
	       				,fit:true,border:false,fitColumns:true,striped:true">
	    <thead>
	        <tr>
	        	<th data-options="field:'ck',checkbox:true"></th>
	        	<th data-options="field:'id',width:80">编号</th>
	            <th data-options="field:'appid',width:80">应用编号</th>
	            <th data-options="field:'orgid',width:80">部门编号</th>
	            <th data-options="field:'userid',width:80">工号</th>
	            <th data-options="field:'level',width:80">层级</th>
	            <th data-options="field:'status',width:80">状态</th>
	        </tr>
	    </thead>
	</table>
<div id="appPermissionInfoAdd" class="easyui-window" title="新增" data-options="modal:true,closed:true,iconCls:'icon-save',href:'/dpm/dpmManage/appPermissionPc_toPage.action?pageType=toAddPage'" style="width:600px;height:300px;padding:10px;">
        The window content.
</div>
<div id="appPermissionInfoEdit" class="easyui-window" title="编辑" data-options="modal:true,closed:true,iconCls:'icon-edit',href:'/dpm/dpmManage/appPermissionPc_toPage.action?pageType=toEditPage'" style="width:600px;height:300px;padding:10px;">
        The window content.
</div>
    ...
    handler:function(){
    	...
    	$.messager.confirm('确认','确定删除ID为 '+ids+' 的信息吗？',function(r){
    	    if (r){
    	    	...
    	    	$.ajax({
    				   type: "POST",
    				   url: "/dpm/dpmManage/appPermissionPc_delete.action",
    				   data: {'ids':ids},
